...
async def joey_dsvs1 (event):
    ...
    if Counter <= 0:
        ...
        file1.write("\nCHECKED BY UltraBot. GET YOUR OWN UltraBot FROM @joey_dsvs1 . \n")
        file1.close()
        ok.delete()
...
**✅Send Screenshot To @chatherebroh . Thanks For Using Me. 
Bot Made By @joey_dsvs1 **"""
        if meke.get("token"):
